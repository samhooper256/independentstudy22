...
//		).get());
	...
	/* Example 12 (H): Given a List<State>, return a Map<State, Integer> mapping each state to the sum of the
	 * populations of its 5 largest cities. Each state will have at least 5 cities. */
